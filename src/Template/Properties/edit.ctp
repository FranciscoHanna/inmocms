    ...
    <div class="text-muted pt-2 w-100">
        <div class="row">
            <div class="col-12">
                ...
                <?= $this->Form->control('title', ['div' => false, 'label' => false, 'class' => 'form-control form-control-lg']); ?>
                <div class="my-3">
                ...
                <div class="clearfix">
                    <span class="float-right">
                        ...
                        <?= $this->Form->button('Guardar cambios', ['class' => 'btn btn-primary mt-3']) ?>
                    </span>
                </div>
            </div>
        </div>
